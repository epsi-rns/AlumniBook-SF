<?php 
	...
	$org_id = $form->getObject()->getOrgId();
	...
	$url_form = url_for('org/'
		.($isNew ? 'create' : 'update?org_id='.$org_id));
?>

<script type="text/javascript">
	window.addEvent("domready",function(){	
		document.id('organization_name').addClass('required');
        ...
        <td colspan="2">
          ...
          <?php if (!$isNew): ?>
            &nbsp;<?php echo link_to(__('Delete'), 
				'org/delete?org_id='.$org_id, $attr_dele) ?>
          <?php endif; ?>
